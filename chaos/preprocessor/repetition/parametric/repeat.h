...
#    define CHAOS_PP_REPEAT_PARAMETRIC(count, ...) CHAOS_PP_REPEAT_PARAMETRIC_S(CHAOS_PP_STATE(), count, __VA_ARGS__)
#    define CHAOS_PP_REPEAT_PARAMETRIC_ CHAOS_PP_LAMBDA(CHAOS_PP_REPEAT_PARAMETRIC_ID)()
# else
#    define CHAOS_PP_REPEAT_PARAMETRIC(count, macro, data) CHAOS_PP_REPEAT_PARAMETRIC_S(CHAOS_PP_STATE(), count, macro, data)
# endif
#
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_REPEAT_PARAMETRIC_S(s, count, ...) CHAOS_PP_DELINEATE_PARAMETRIC_S(s, count, CHAOS_PP_EMPTY, __VA_ARGS__)
#    define CHAOS_PP_REPEAT_PARAMETRIC_S_ CHAOS_PP_LAMBDA(CHAOS_PP_REPEAT_PARAMETRIC_S_ID)()
# else
#    define CHAOS_PP_REPEAT_PARAMETRIC_S(s, count, macro, data) CHAOS_PP_DELINEATE_PARAMETRIC_S(s, count, CHAOS_PP_EMPTY, macro, data)
# endif
#
