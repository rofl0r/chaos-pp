...
#
# define CHAOS_IP_FOR_PARAMETRIC_U(s, size, pred, op, macro, ps) \
    CHAOS_IP_FOR_PARAMETRIC_I(CHAOS_PP_NEXT(s), CHAOS_PP_BUFFER(s, size), pred, op, macro, ps) \
    /**/
# define CHAOS_IP_FOR_PARAMETRIC_I(s, buffer, pred, op, macro, ps) \
    CHAOS_IP_FOR_PARAMETRIC_II(s, s, buffer, buffer, pred, CHAOS_PP_CALL(pred), op, CHAOS_PP_CALL(op), macro, CHAOS_PP_CALL(macro), ps) \
    /**/
...
# define CHAOS_IP_FOR_PARAMETRIC_II(s, o, buffer, shelf, pred, _p, op, _o, macro, _m, ps) \
    CHAOS_PP_IIF(CHAOS_PP_BITAND(CHAOS_PP_IS_VALID(buffer))(CHAOS_PP_NOT_EQUAL(buffer, CHAOS_PP_LIMIT_EXPR)))( \
        CHAOS_IP_FOR_PARAMETRIC_III, CHAOS_IP_FOR_PARAMETRIC_P \
    )(s, o, buffer, shelf, pred, _p, op, _o, macro, _m, ps) \
    /**/
# define CHAOS_IP_FOR_PARAMETRIC_III(s, o, buffer, shelf, pred, _p, op, _o, macro, _m, ps) \
    CHAOS_PP_DEFER(CHAOS_PP_EXPR_S(s))(CHAOS_PP_DEFER(CHAOS_PP_IIF)(_p()(s, pred, CHAOS_PP_UNPACK ps))( \
        CHAOS_IP_FOR_PARAMETRIC_IV, \
        CHAOS_PP_TUPLE_EAT(11) \
    )(CHAOS_PP_NEXT(s), o, CHAOS_PP_NEXT(buffer), shelf, pred, _p, op, _o, macro, _m, ps)) \
    /**/
# define CHAOS_IP_FOR_PARAMETRIC_IV(s, o, buffer, shelf, pred, _p, op, _o, macro, _m, ps) \
    _m()(s, macro, CHAOS_PP_UNPACK ps) \
    ...
    /**/
# define CHAOS_IP_FOR_PARAMETRIC_P(s, o, buffer, shelf, pred, _p, op, _o, macro, _m, ps) \
