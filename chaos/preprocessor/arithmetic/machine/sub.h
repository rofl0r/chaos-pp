...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_SUB_MACHINE_S(s, x, y) CHAOS_PP_EXPR_S(s)(CHAOS_PP_MACHINE_S(s, (, 0xSUB, x, y, 0xSTOP,)))
...
#    define CHAOS_PP_INSTRUCTION_0xSUB(s, p, x, y, k, ...) \
        CHAOS_PP_IF(y)( \
            (, 0xSUB, CHAOS_PP_DEC(x), CHAOS_PP_DEC(y), k, p ## __VA_ARGS__), \
            (, k, x, p ## __VA_ARGS__) \
        ) \
        /**/
# endif
