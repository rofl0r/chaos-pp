...
# /* CHAOS_PP_AUTO_CAT */
#
# define CHAOS_PP_AUTO_CAT CHAOS_PP_CAT_SHADOW(CHAOS_IP_AUTO_CAT_, CHAOS_PP_AUTO_REC(CHAOS_IP_AUTO_CAT_P, 16))
...
#
# define CHAOS_PP_PRIMITIVE_AUTO_CAT CHAOS_PP_CAT_SHADOW(CHAOS_IP_PRIMITIVE_AUTO_CAT_, CHAOS_PP_AUTO_REC(CHAOS_IP_AUTO_CAT_P, 16))
