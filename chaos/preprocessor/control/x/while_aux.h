...
#    define CHAOS_PP_WHILE_AUX_X_S(s, size, pred, op, data, ...) \
        CHAOS_IP_WHILE_AUX_X_U(s, size, pred, op, CHAOS_PP_EXPR_IIF(CHAOS_PP_IS_VARIADIC(data))(CHAOS_PP_TUPLE_REM(?))(data), (__VA_ARGS__)) \
        /**/
...
#    define CHAOS_PP_WHILE_AUX_X_S(s, size, pred, op, data, state) \
        CHAOS_IP_WHILE_AUX_X_U(s, size, pred, op, CHAOS_PP_EXPR_IIF(CHAOS_PP_IS_UNARY(data))(CHAOS_PP_TUPLE_REM(1))(data), (state)) \
        /**/
# endif
#
