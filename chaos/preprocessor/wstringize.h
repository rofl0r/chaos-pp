...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_PRIMITIVE_WSTRINGIZE(...) CHAOS_PP_PRIMITIVE_CAT_SHADOW(L, #__VA_ARGS__)
#    define CHAOS_PP_PRIMITIVE_WSTRINGIZE_ CHAOS_PP_LAMBDA(CHAOS_PP_PRIMITIVE_WSTRINGIZE)
# else
#    define CHAOS_PP_PRIMITIVE_WSTRINGIZE(x) CHAOS_PP_PRIMITIVE_CAT_SHADOW(L, #x)
# endif
#
