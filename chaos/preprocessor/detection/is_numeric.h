...
#    define CHAOS_PP_IS_NUMERIC(x) \
        CHAOS_PP_IIF_SHADOW(CHAOS_PP_IS_VARIADIC(x))( \
            0, \
            CHAOS_PP_IS_EMPTY(CHAOS_PP_CAT_SHADOW(CHAOS_PP_INTERCEPT, x)) \
        ) \
        /**/
#    define CHAOS_PP_IS_NUMERIC_ CHAOS_PP_LAMBDA(CHAOS_PP_IS_NUMERIC)
# else
#    define CHAOS_PP_IS_NUMERIC(x) CHAOS_PP_IS_EMPTY(CHAOS_PP_CAT_SHADOW(CHAOS_PP_INTERCEPT, x))
# endif
#
