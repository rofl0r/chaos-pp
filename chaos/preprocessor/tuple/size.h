...
# endif
#
# /* CHAOS_PP_VARIADIC_QUICK_SIZE */
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_VARIADIC_QUICK_SIZE(...) CHAOS_PP_TUPLE_QUICK_SIZE((__VA_ARGS__))
#    define CHAOS_PP_VARIADIC_QUICK_SIZE_ID() CHAOS_PP_VARIADIC_QUICK_SIZE
#    define CHAOS_PP_VARIADIC_QUICK_SIZE_ CHAOS_PP_LAMBDA(CHAOS_PP_VARIADIC_QUICK_SIZE)
# endif
#
...
# endif
#
# /* CHAOS_PP_VARIADIC_SIZE_BYPASS */
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_VARIADIC_SIZE_BYPASS(s, ...) CHAOS_PP_TUPLE_SIZE_BYPASS(s, (__VA_ARGS__))
#    define CHAOS_PP_VARIADIC_SIZE_BYPASS_ID() CHAOS_PP_VARIADIC_SIZE_BYPASS
#    define CHAOS_PP_VARIADIC_SIZE_BYPASS_ CHAOS_PP_LAMBDA(CHAOS_PP_VARIADIC_SIZE)
# endif
#
# endif
