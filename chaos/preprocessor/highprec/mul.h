...
#
# define CHAOS_IP_MUL_HP_OPT_I(n, col) CHAOS_IP_MUL_HP_OPT_II((+) CHAOS_IP_MUL_HP_COL_ ## n col(CHAOS_PP_COMMA() CHAOS_PP_REM))
# define CHAOS_IP_MUL_HP_OPT_II(im) CHAOS_IP_MUL_HP_OPT_III(im)
# define CHAOS_IP_MUL_HP_OPT_III(seq, digit) digit, CHAOS_PP_INDIRECT(CHAOS_PP_SEQ_SIZE(CHAOS_PP_EAT seq))
#
# endif
