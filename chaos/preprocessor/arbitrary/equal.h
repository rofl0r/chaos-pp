...
#    define CHAOS_PP_ARBITRARY_EQUAL_INTERNAL(x, y) \
        CHAOS_PP_IS_UNARY(CHAOS_PP_SCAN(1)( \
            CHAOS_IP_ARBITRARY_EQUAL_M(0) CHAOS_PP_ARBITRARY_FMERGE(x, y, CHAOS_IP_ARBITRARY_EQUAL_M, 0)() \
        )) \
        /**/
# else
#    define CHAOS_PP_ARBITRARY_EQUAL_INTERNAL(x, y) \
        CHAOS_PP_IS_UNARY(CHAOS_PP_SCAN(1)( \
            CHAOS_IP_ARBITRARY_EQUAL_M(0) CHAOS_PP_ARBITRARY_FMERGE(x, y, CHAOS_IP_ARBITRARY_EQUAL_M, 0)(CHAOS_PP_DEFER(CHAOS_PP_EMPTY)()) \
        )) \
        /**/
# endif
#
