...
#    define CHAOS_PP_ENUM_PARAMETRIC(size, count, ...) CHAOS_PP_ENUM_PARAMETRIC_S(CHAOS_PP_STATE(), size, count, __VA_ARGS__)
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_ENUM_PARAMETRIC_S(s, size, count, ...) CHAOS_PP_DELINEATE_PARAMETRIC_S(s, size, count, CHAOS_PP_COMMA, __VA_ARGS__)
