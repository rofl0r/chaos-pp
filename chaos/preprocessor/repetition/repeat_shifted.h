...
#    define CHAOS_PP_REPEAT_SHIFTED(count, ...) CHAOS_PP_REPEAT_SHIFTED_S(CHAOS_PP_STATE(), count, __VA_ARGS__)
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_REPEAT_SHIFTED_S(s, count, ...) CHAOS_PP_DELINEATE_SHIFTED_S(s, count, CHAOS_PP_EMPTY, __VA_ARGS__)
