...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_DELINEATE_SHIFTED_TRAILING_X_S(s, size, count, sep, ...) CHAOS_PP_EXPR_IF(CHAOS_PP_DEC(count))(sep()) CHAOS_PP_DELINEATE_SHIFTED_X_S(s, size, count, sep, __VA_ARGS__)
#    define CHAOS_PP_DELINEATE_SHIFTED_TRAILING_X_S_ CHAOS_PP_LAMBDA(CHAOS_PP_DELINEATE_SHIFTED_TRAILING_X_S_ID)()
# else
#    define CHAOS_PP_DELINEATE_SHIFTED_TRAILING_X_S(s, size, count, sep, macro, data) CHAOS_PP_EXPR_IF(CHAOS_PP_DEC(count))(sep()) CHAOS_PP_DELINEATE_SHIFTED_X_S(s, size, count, sep, macro, data)
# endif
#
