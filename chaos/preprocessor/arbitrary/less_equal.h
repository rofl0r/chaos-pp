...
# define CHAOS_PP_ARBITRARY_LESS_EQUAL_INTERNAL(x, y) \
    CHAOS_PP_COMPL(CHAOS_PP_SCAN(1)( \
        CHAOS_IP_ARBITRARY_LESS_EQUAL_M(1) CHAOS_PP_FMERGE(x, y, CHAOS_IP_ARBITRARY_LESS_EQUAL_M, 0)(CHAOS_PP_DEC) \
    )) \
    /**/
#
...
# define CHAOS_IP_ARBITRARY_LESS_EQUAL_1(a, b) CHAOS_PP_INDIRECT(CHAOS_PP_REL(a, b))
