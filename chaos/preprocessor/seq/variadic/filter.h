...
#    define CHAOS_PP_VARIADIC_SEQ_FILTER(pred, seq, ...) CHAOS_PP_VARIADIC_SEQ_FILTER_S(CHAOS_PP_STATE(), pred, seq, __VA_ARGS__)
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_VARIADIC_SEQ_FILTER_S(s, pred, seq, ...) CHAOS_PP_DEFER(CHAOS_PP_SEQ_UNZIP)(CHAOS_PP_SEQ_FILTER_S(s, pred, CHAOS_PP_SEQ_ZIP(seq), __VA_ARGS__))
