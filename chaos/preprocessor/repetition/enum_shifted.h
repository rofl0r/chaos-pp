...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_ENUM_SHIFTED_PARAMETRIC(size, count, macro, ...) CHAOS_PP_ENUM_SHIFTED_PARAMETRIC_S(CHAOS_PP_STATE(), size, count, macro, __VA_ARGS__)
#    define CHAOS_PP_ENUM_SHIFTED_PARAMETRIC_ CHAOS_PP_LAMBDA(CHAOS_PP_ENUM_SHIFTED_PARAMETRIC_ID)()
# else
#    define CHAOS_PP_ENUM_SHIFTED_PARAMETRIC(size, count, macro, data) CHAOS_PP_ENUM_SHIFTED_PARAMETRIC_S(CHAOS_PP_STATE(), size, count, macro, data)
# endif
#
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_ENUM_SHIFTED_PARAMETRIC_S(s, size, count, macro, ...) CHAOS_PP_DELINEATE_SHIFTED_PARAMETRIC_S(s, size, count, CHAOS_PP_COMMA, macro, __VA_ARGS__)
#    define CHAOS_PP_ENUM_SHIFTED_PARAMETRIC_S_ CHAOS_PP_LAMBDA(CHAOS_PP_ENUM_SHIFTED_PARAMETRIC_S_ID)()
# else
#    define CHAOS_PP_ENUM_SHIFTED_PARAMETRIC_S(s, size, count, macro, data) CHAOS_PP_DELINEATE_SHIFTED_PARAMETRIC_S(s, size, count, CHAOS_PP_COMMA, macro, data)
# endif
#
