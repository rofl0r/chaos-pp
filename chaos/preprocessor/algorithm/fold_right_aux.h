...
#    define CHAOS_PP_FOLD_RIGHT_AUX_S(s, op, g, data, ...) \
        CHAOS_IP_FOLD_RIGHT_AUX_U(s, op, g, CHAOS_PP_INLINE_WHEN(CHAOS_PP_IS_VARIADIC(data))(CHAOS_PP_TUPLE_REM(?))(data), (__VA_ARGS__)) \
        /**/
...
#    define CHAOS_PP_FOLD_RIGHT_AUX_S(s, op, g, data, state) \
        CHAOS_IP_FOLD_RIGHT_AUX_U(s, op, g, CHAOS_PP_INLINE_WHEN(CHAOS_PP_IS_UNARY(data))(CHAOS_PP_TUPLE_REM(1))(data), (state)) \
        /**/
# endif
#
