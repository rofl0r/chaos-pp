...
#    define CHAOS_PP_TRANSFORM_PARAMETRIC(size, op, g, ...) CHAOS_PP_TRANSFORM_PARAMETRIC_S(CHAOS_PP_STATE(), size, op, g, __VA_ARGS__)
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_TRANSFORM_PARAMETRIC_S(s, size, op, g, ...) \
