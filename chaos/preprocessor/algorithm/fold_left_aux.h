...
#    define CHAOS_PP_FOLD_LEFT_AUX_S(s, op, g, data, ...) \
        CHAOS_IP_FOLD_LEFT_AUX_U(s, op, g, CHAOS_PP_INLINE_WHEN(CHAOS_PP_IS_VARIADIC(data))(CHAOS_PP_REM)(data), (__VA_ARGS__)) \
        /**/
...
#    define CHAOS_PP_FOLD_LEFT_AUX_S(s, op, g, data, state) \
        CHAOS_IP_FOLD_LEFT_AUX_U(s, op, g, CHAOS_PP_INLINE_WHEN(CHAOS_PP_IS_UNARY(data))(CHAOS_PP_REM)(data), (state)) \
        /**/
# endif
#
