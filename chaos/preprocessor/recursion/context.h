...
# define CHAOS_IP_ABSOLUTE_I(res) \
    CHAOS_PP_EXPR_IIF_SHADOW(CHAOS_PP_IS_UNARY(res))(CHAOS_PP_SPLIT_SHADOW(0, CHAOS_IP_ABSOLUTE_II res)) \
    /**/
# define CHAOS_IP_ABSOLUTE_II(x) x, ...
#
# define CHAOS_IP_ABSOLUTE_A(n, bit) CHAOS_PP_IIF_SHADOW(CHAOS_PP_IS_NULLARY(CHAOS_IP_CONTEXT_I(n, bit)(())))(CHAOS_IP_ABSOLUTE_B, (bit))
# define CHAOS_IP_ABSOLUTE_B(n, bit) CHAOS_PP_IIF_SHADOW(CHAOS_PP_IS_NULLARY(CHAOS_IP_CONTEXT_I(n, bit)(())))(CHAOS_IP_ABSOLUTE_A, (bit))
#
# /* CHAOS_PP_RELATIVE */
#
# define CHAOS_PP_RELATIVE(n) CHAOS_PP_PRIMITIVE_CAT_SHADOW(CHAOS_IP_RELATIVE_, n)(CHAOS_IP_CONTEXT_N())
