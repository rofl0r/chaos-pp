...
#    define CHAOS_PP_TUPLE_TO_STRING_ALT_BYPASS(s, tuple) \
        CHAOS_PP_EXPR_S(s)(CHAOS_IP_TUPLE_TO_STRING_ALT_0( \
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_IP_TUPLE_TO_STRING_ALT_INDIRECT(n) CHAOS_IP_TUPLE_TO_STRING_ALT_ ## n
#    define CHAOS_IP_TUPLE_TO_STRING_ALT_0(_, s, tuple) \
        CHAOS_PP_IIF _(CHAOS_PP_TUPLE_IS_BATCH(10, tuple))( \
            CHAOS_PP_TUPLE_TO_STRING _(10, CHAOS_PP_TUPLE_BATCH _(10, tuple)) \
            CHAOS_PP_EXPR_S _(s)(CHAOS_IP_TUPLE_TO_STRING_ALT_INDIRECT _(0)( \
                CHAOS_PP_OBSTRUCT _(), CHAOS_PP_PREV(s), CHAOS_PP_TUPLE_SANS_BATCH _(10, tuple) \
            )), \
            CHAOS_PP_EXPR_S _(s)(CHAOS_IP_TUPLE_TO_STRING_ALT_INDIRECT _(1)( \
                CHAOS_PP_OBSTRUCT _(), CHAOS_PP_PREV(s), tuple \
            )) \
        ) \
        /**/
#    define CHAOS_IP_TUPLE_TO_STRING_ALT_1(_, s, tuple) \
