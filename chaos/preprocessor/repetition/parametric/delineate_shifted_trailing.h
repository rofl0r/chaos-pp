...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_DELINEATE_SHIFTED_TRAILING_PARAMETRIC_S(s, count, sep, ...) CHAOS_PP_EXPR_IF(CHAOS_PP_DEC(count))(sep()) CHAOS_PP_DELINEATE_SHIFTED_PARAMETRIC_S(s, count, sep, __VA_ARGS__)
...
# else
#    define CHAOS_PP_DELINEATE_SHIFTED_TRAILING_PARAMETRIC_S(s, count, sep, macro, data) CHAOS_PP_EXPR_IF(CHAOS_PP_DEC(count))(sep()) CHAOS_PP_DELINEATE_SHIFTED_PARAMETRIC_S(s, count, sep, macro, data)
# endif
#
