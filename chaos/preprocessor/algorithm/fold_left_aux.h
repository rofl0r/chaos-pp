...
#    define CHAOS_PP_FOLD_LEFT_AUX_S(s, op, g, data, ...) \
        CHAOS_IP_FOLD_LEFT_AUX_U(s, op, g, CHAOS_PP_INLINE_WHEN(CHAOS_PP_IS_VARIADIC(data))(CHAOS_PP_TUPLE_REM(?))(data), (__VA_ARGS__)) \
        /**/
...
#    define CHAOS_PP_FOLD_LEFT_AUX_S(s, op, g, data, state) \
        CHAOS_IP_FOLD_LEFT_AUX_U(s, op, g, CHAOS_PP_INLINE_WHEN(CHAOS_PP_IS_UNARY(data))(CHAOS_PP_TUPLE_REM(1))(data), (state)) \
        /**/
# endif
#
...
# define CHAOS_IP_FOLD_LEFT_AUX_U(s, op, g, data, ps) \
    ...
    ) CHAOS_PP_REM ps CHAOS_IP_FOLD_LEFT_AUX_2(CHAOS_PP_OBSTRUCT(), CHAOS_PP_NEXT(s), g)) \
    /**/
