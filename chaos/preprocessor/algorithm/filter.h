...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_FILTER_S(s, pred, g, ...) CHAOS_IP_FILTER_U(s, pred, CHAOS_PP_IS_VARIADIC(pred), g, (__VA_ARGS__))
#    define CHAOS_PP_FILTER_S_ CHAOS_PP_LAMBDA(CHAOS_PP_FILTER_S_ID)()
# else
#    define CHAOS_PP_FILTER_S(s, pred, g, data) CHAOS_IP_FILTER_U(s, pred, 0, g, (data))
# endif
#
