...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_WHILE_AUX_X_S(s, size, pred, op, data, ...) \
        CHAOS_IP_WHILE_AUX_X_U(s, size, pred, op, CHAOS_PP_INLINE_WHEN(CHAOS_PP_IS_VARIADIC(data))(CHAOS_PP_REM)(data), (__VA_ARGS__)) \
        /**/
#    define CHAOS_PP_WHILE_AUX_X_S_ CHAOS_PP_LAMBDA(CHAOS_PP_WHILE_AUX_X_S_ID)()
# else
#    define CHAOS_PP_WHILE_AUX_X_S(s, size, pred, op, data, state) \
        CHAOS_IP_WHILE_AUX_X_U(s, size, pred, op, CHAOS_PP_INLINE_WHEN(CHAOS_PP_IS_UNARY(data))(CHAOS_PP_REM)(data), (state)) \
        /**/
# endif
#
...
# define CHAOS_IP_WHILE_AUX_X_III(_, s, jump, fix, pred, _p, op, _o, data, ps) \
    _(1, CHAOS_PP_IIF)(_(0, _p)()(s, pred, CHAOS_PP_REM data _(0, CHAOS_PP_COMMA)() CHAOS_PP_REM ps))( \
        _(1, CHAOS_PP_EXPR_S)(s), CHAOS_PP_REM ps CHAOS_PP_EAT \
    )( \
        _(1, CHAOS_IP_WHILE_AUX_X_INDIRECT)()( \
            CHAOS_PP_NEXT(s), jump, fix, pred, _p, op, _o, data, \
            (_(0, _o)()(s, op, CHAOS_PP_REM data _(0, CHAOS_PP_COMMA)() CHAOS_PP_REM ps)) \
        ) \
    ) \
    /**/
