...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_IP_EXECUTE_A(b, ...) (CHAOS_PP_TUPLE_REM, __VA_ARGS__ CHAOS_PP_EXPR_IIF_SHADOW(b)(CHAOS_PP_EMPTY)) CHAOS_IP_EXECUTE_B
#    define CHAOS_IP_EXECUTE_B(b, ...) (CHAOS_PP_TUPLE_REM, __VA_ARGS__ CHAOS_PP_EXPR_IIF_SHADOW(b)(CHAOS_PP_EMPTY)) CHAOS_IP_EXECUTE_A
#    define CHAOS_IP_EXECUTE_X(m, ...) m(?)(__VA_ARGS__() CHAOS_IP_EXECUTE_Y)
#    define CHAOS_IP_EXECUTE_Y(m, ...) m(?)(__VA_ARGS__() CHAOS_IP_EXECUTE_X)
# else
#    define CHAOS_IP_EXECUTE_A(b, x) (CHAOS_PP_TUPLE_REM, x CHAOS_PP_EXPR_IIF_SHADOW(b)(CHAOS_PP_EMPTY)) CHAOS_IP_EXECUTE_B
#    define CHAOS_IP_EXECUTE_B(b, x) (CHAOS_PP_TUPLE_REM, x CHAOS_PP_EXPR_IIF_SHADOW(b)(CHAOS_PP_EMPTY)) CHAOS_IP_EXECUTE_A
