...
# define CHAOS_IP_FOR_EACH_I_X_IV(_, s, jump, fix, n, macro, _m, type, g, pd) \
    _(0, _m)()(s, macro, n _(0, CHAOS_PP_COMMA)() CHAOS_PP_ITEM(type, CHAOS_PP_FIRST(g)) _(0, CHAOS_PP_EXPOSE)(pd)) \
    _(1, CHAOS_PP_EXPR_S)(s)(_(1, CHAOS_IP_FOR_EACH_I_X_INDIRECT)()( \
        CHAOS_PP_NEXT(s), jump, fix, CHAOS_PP_INC(n), macro, _m, type, CHAOS_PP_REST(g), pd \
    )) \
    /**/
# define CHAOS_IP_FOR_EACH_I_X_V(_, s, jump, fix, n, macro, _m, type, g, pd) \
    CHAOS_IP_FOR_EACH_I_X_VI(CHAOS_PP_SEQ_FIRST(jump), CHAOS_PP_SEQ_REST(jump), fix, n, macro, _m, type, g, pd) \
    /**/
