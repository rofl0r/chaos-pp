...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_DELINEATE_FROM_TO_TRAILING_X_S(s, size, from, to, sep, ...) CHAOS_PP_INLINE_WHEN(CHAOS_PP_NOT_EQUAL(from, to))(sep()) CHAOS_PP_DELINEATE_FROM_TO_X_S(s, size, from, to, sep, __VA_ARGS__)
#    define CHAOS_PP_DELINEATE_FROM_TO_TRAILING_X_S_ CHAOS_PP_LAMBDA(CHAOS_PP_DELINEATE_FROM_TO_TRAILING_X_S_ID)()
# else
#    define CHAOS_PP_DELINEATE_FROM_TO_TRAILING_X_S(s, size, from, to, sep, macro, data) CHAOS_PP_INLINE_WHEN(CHAOS_PP_NOT_EQUAL(from, to))(sep()) CHAOS_PP_DELINEATE_FROM_TO_X_S(s, size, from, to, sep, macro, data)
# endif
#
