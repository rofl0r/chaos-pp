...
#    define CHAOS_PP_CALL(x) CHAOS_PP_CAT_SHADOW(CHAOS_IP_CALL_, CHAOS_PP_IS_VARIADIC(x))
...
#    define CHAOS_IP_CALL_11(s, expr, ...) CHAOS_PP_DEFER(CHAOS_PP_EXPR_S(s))(CHAOS_PP_INVOKE_S(s, expr, __VA_ARGS__))
# else
