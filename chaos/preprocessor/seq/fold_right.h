...
#
# define CHAOS_IP_SEQ_FOLD_RIGHT_I(seq, ps) CHAOS_IP_SEQ_FOLD_RIGHT_A seq CHAOS_PP_REM ps CHAOS_IP_SEQ_FOLD_RIGHT_B seq
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_IP_SEQ_FOLD_RIGHT_A(i, ...) CHAOS_PP_IIF(i)(CHAOS_IP_SEQ_FOLD_RIGHT_A_I, CHAOS_PP_EAT)(__VA_ARGS__)
#    define CHAOS_IP_SEQ_FOLD_RIGHT_A_I(s, op, _o, ...) _o()(s, op) __VA_ARGS__, CHAOS_IP_SEQ_FOLD_RIGHT_A_INDIRECT
#    define CHAOS_IP_SEQ_FOLD_RIGHT_B(i, ...) CHAOS_PP_INLINE_WHEN(i)(CHAOS_PP_PLANAR_CLOSE() CHAOS_IP_SEQ_FOLD_RIGHT_B_INDIRECT)
# else
...
#    define CHAOS_IP_SEQ_FOLD_RIGHT_B(aux, x) CHAOS_PP_INLINE_WHEN(CHAOS_PP_TUPLE_ELEM(4, 0, aux))(CHAOS_PP_PLANAR_CLOSE() CHAOS_IP_SEQ_FOLD_RIGHT_B_INDIRECT)
# endif
#
# endif
