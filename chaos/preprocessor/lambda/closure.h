...
# define CHAOS_PP_CLOSURE(macro, arity) \
    ...
    CHAOS_PP_OPERATOR(CHAOS_PP_LPAREN) CHAOS_PP_PRIMITIVE_CAT_SHADOW(CHAOS_IP_CLOSURE_, arity) \
    /**/
...
# define CHAOS_PP_IS_BOUND(cl) \
    CHAOS_PP_IS_EMPTY(CHAOS_PP_CAT_SHADOW(CHAOS_IP_IS_BOUND_A cl, 0x0)) \
    /**/
