...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_IP_EXECUTE_I(bit, ...) CHAOS_PP_IIF(bit)(CHAOS_IP_EXECUTE_II, CHAOS_PP_EAT)(__VA_ARGS__)
#    define CHAOS_IP_EXECUTE_II(...) __VA_ARGS__() CHAOS_IP_EXECUTE_INDIRECT
# else
#    define CHAOS_IP_EXECUTE_I(bit, x) CHAOS_PP_IIF(bit)(CHAOS_IP_EXECUTE_II, CHAOS_PP_EAT)(x)
