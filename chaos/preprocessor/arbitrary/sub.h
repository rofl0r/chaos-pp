...
#    define CHAOS_PP_ARBITRARY_SUB_INTERNAL(x, y) \
        CHAOS_PP_ARBITRARY_FIX_INTERNAL(CHAOS_PP_SEQ_REVERSE(CHAOS_PP_SCAN(1)( \
            CHAOS_IP_ARBITRARY_SUB_M(0) CHAOS_PP_RMERGE(x, y, CHAOS_IP_ARBITRARY_SUB_M, 0)() \
        ))) \
        /**/
# else
#    define CHAOS_PP_ARBITRARY_SUB_INTERNAL(x, y) \
        CHAOS_PP_ARBITRARY_FIX_INTERNAL(CHAOS_PP_SEQ_REVERSE(CHAOS_PP_SCAN(1)( \
            CHAOS_IP_ARBITRARY_SUB_M(0) CHAOS_PP_RMERGE(x, y, CHAOS_IP_ARBITRARY_SUB_M, 0)(CHAOS_PP_DEFER(CHAOS_PP_EMPTY)()) \
        ))) \
        /**/
# endif
#
