...
# define CHAOS_IP_DIV_1(_, s, r, x, y, z) \
    CHAOS_PP_IIF_SHADOW _(CHAOS_PP_IS_VALID(s))( \
        CHAOS_PP_IF_SHADOW _(z)( \
            CHAOS_PP_EXPONENTIAL(s, CHAOS_PP_PREV, CHAOS_IP_DIV_INDIRECT, CHAOS_PP_TUPLE_REM_SHADOW(4)(r, CHAOS_PP_DEC(x), y, CHAOS_PP_DEC(z))), \
            CHAOS_PP_IF_SHADOW _(CHAOS_PP_LESS_EQUAL(y, x))( \
                CHAOS_PP_EXPONENTIAL(s, CHAOS_PP_PREV, CHAOS_IP_DIV_INDIRECT, CHAOS_PP_TUPLE_REM_SHADOW(4)(CHAOS_PP_INC(r), x, y, y)), \
