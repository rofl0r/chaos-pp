...
# endif
#
# /* CHAOS_PP_LIMIT_BLOCK */
#
# define CHAOS_PP_LIMIT_BLOCK 5
# define CHAOS_PP_LIMIT_BLOCK_ID() CHAOS_PP_LIMIT_BLOCK
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_LIMIT_BLOCK_ CHAOS_PP_LAMBDA(CHAOS_PP_LIMIT_BLOCK_ID)()
# endif
#
...
# endif
#
# /* CHAOS_PP_LIMIT_EXPANDER */
#
# define CHAOS_PP_LIMIT_EXPANDER 5
# define CHAOS_PP_LIMIT_EXPANDER_ID() CHAOS_PP_LIMIT_EXPANDER
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_LIMIT_EXPANDER_ CHAOS_PP_LAMBDA(CHAOS_PP_LIMIT_EXPANDER_ID)()
# endif
#
# /* CHAOS_PP_LIMIT_EXPR */
#
...
# endif
#
# /* CHAOS_PP_LIMIT_HIGHER_ORDER */
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_LIMIT_HIGHER_ORDER 8
#    define CHAOS_PP_LIMIT_HIGHER_ORDER_ID() CHAOS_PP_LIMIT_HIGHER_ORDER
#    define CHAOS_PP_LIMIT_HIGHER_ORDER_ CHAOS_PP_LAMBDA(CHAOS_PP_LIMIT_HIGHER_ORDER_ID)()
# endif
#
...
# endif
#
# /* CHAOS_PP_LIMIT_PHASE */
#
# define CHAOS_PP_LIMIT_PHASE 5
# define CHAOS_PP_LIMIT_PHASE_ID() CHAOS_PP_LIMIT_PHASE
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_LIMIT_PHASE_ CHAOS_PP_LAMBDA(CHAOS_PP_LIMIT_PHASE_ID)()
# endif
#
