...
#    define CHAOS_PP_REPEAT_SHIFTED_PARAMETRIC(size, count, ...) CHAOS_PP_REPEAT_SHIFTED_PARAMETRIC_S(CHAOS_PP_STATE(), size, count, __VA_ARGS__)
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_REPEAT_SHIFTED_PARAMETRIC_S(s, size, count, ...) CHAOS_PP_DELINEATE_SHIFTED_PARAMETRIC_S(s, size, count, CHAOS_PP_EMPTY, __VA_ARGS__)
